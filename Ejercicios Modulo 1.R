...
#RTA: La principal dferencia entre estos vectores es que en c() solo permte la entrada de un tipo de datos (character, numeric, logical, etc), mientras que la entrada de datos en la función list() no tiene restricción en el tipo de datos.

A <- c(5,"texto", 20, FALSE, 8)
class(A) #Pese a que tenemos numeros, logicals y caracteres, la clase solo nos indica que supuestamente hay datos unicamente de caracteres.
class(A[[1]])
...
matriz[,2, drop=FALSE] #Devuelve los resultados manteniendo su forma de matriz con el argumento "drop".
